...
{
    public partial class RightClassroomForm : Form, ClassroomFormInterface
    {
        ...
        {
            StudentCheckInForm studentCheckInForm = new StudentCheckInForm();
            //studentCheckInForm.showFormDialog(this.mainForm, this.roomDetail, this.classroomDetailDictionary);
            studentCheckInForm.showFormDialog(this.roomDetailList, this.classroomDetailDictionary);
        }
